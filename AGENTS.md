...
- Name the bb version whenever `BB_VERSION` moves. The changelog tracks the image's own version; bb rides its own axis, and an entry that says "carries bb 0.43.3" answers the question people actually have.
