...
- The usual CLI gaps filled by apt: `ps`, `less`, `unzip`, `pkg-config`, `gpg`, `rsync`, `wget`, plus `bubblewrap` for agent sandboxing and `imagemagick` for image work
